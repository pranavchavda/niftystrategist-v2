...
export default function PriceMonitor() {
  ...
  if (loading) {
    return (
      <div className="p-4 md:p-6 bg-zinc-50 min-h-[calc(100vh-56px)]">
        <h1 className="text-3xl font-bold text-zinc-900 mb-2">MAP Enforcement Dashboard</h1>
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 animate-pulse">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="rounded-xl ring-1 ring-zinc-200 bg-white p-6">
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="rounded-xl ring-1 ring-zinc-200 bg-white p-6 h-32" />
          ))}
        </div>
      </div>
    );
  ...
  return (
    <div className="p-4 md:p-6 bg-zinc-50 min-h-[calc(100vh-56px)]">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 md:mb-8 gap-4">
        <div>
          <h1 className="text-3xl font-bold text-zinc-900">MAP Enforcement Dashboard</h1>
      ...
      {dashboardData && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Link to="/price-monitor/matches" className="bg-white rounded-xl ring-1 ring-zinc-200 p-6 shadow-sm hover:shadow-md transition-shadow hover:-translate-y-0.5 transition-transform cursor-pointer">
          ...
          <Link to="/price-monitor/competitors" className="bg-white rounded-xl ring-1 ring-zinc-200 p-6 shadow-sm hover:shadow-md transition-shadow hover:-translate-y-0.5 transition-transform cursor-pointer">
            <div className="flex items-center justify-between mb-3">
          ...
          <Link to="/price-monitor/alerts" className="bg-white rounded-xl ring-1 ring-zinc-200 p-6 shadow-sm hover:shadow-md transition-shadow hover:-translate-y-0.5 transition-transform cursor-pointer">
            <div className="flex items-center justify-between mb-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
        <div className="bg-white rounded-xl ring-1 ring-zinc-200 p-6 shadow-sm hover:shadow-md transition-shadow hover:-translate-y-0.5 transition-transform">
          ...
          <div className="mb-4">
            ...
            <div className="inline-flex rounded-lg bg-zinc-100 p-1">
              <button
                ...
                className={`${matchingThreshold === 'low' ? 'bg-white text-zinc-900 shadow ring-1 ring-zinc-200' : 'text-zinc-600'} px-3 py-1.5 text-sm rounded-md transition-colors disabled:opacity-50`}
              >
                Low
              </button>
              <button
                ...
                className={`${matchingThreshold === 'medium' ? 'bg-white text-zinc-900 shadow ring-1 ring-zinc-200' : 'text-zinc-600'} px-3 py-1.5 text-sm rounded-md transition-colors disabled:opacity-50`}
              >
                Medium
              </button>
              <button
                ...
                className={`${matchingThreshold === 'high' ? 'bg-white text-zinc-900 shadow ring-1 ring-zinc-200' : 'text-zinc-600'} px-3 py-1.5 text-sm rounded-md transition-colors disabled:opacity-50`}
              >
                High
              </button>
            </div>
      ...
      {dashboardData?.recent_activity && (
        <div className="bg-white rounded-xl ring-1 ring-zinc-200 p-6">
      ...
      {!dashboardData && !loading && !error && (
        <div className="bg-white rounded-xl ring-1 ring-zinc-200 p-12 text-center">
